...
4. [Quora.com - How did Bitcoin get started?](https://www.quora.com/How-did-Bitcoin-get-started)
5. [Reddit.com - How was the first bitcoin created?](https://www.reddit.com/r/BitcoinBeginners/comments/1qwwkr/how_was_the_first_bitcoin_created/)
6. [Bitcoin.stackexchange.com - When and how did bitcoin start?](https://bitcoin.stackexchange.com/questions/659/when-and-how-did-bitcoin-start)
7. [Quora.com - In the beginning how did the first recipient receive the first bitcoin if there were no transactions to mine?](https://www.quora.com/In-the-beginning-how-did-the-first-recipient-receive-the-first-bitcoin-if-there-were-no-transactions-to-mine#)
8. [En.bitcoin.it - Genesis block](https://en.bitcoin.it/wiki/Genesis_block)
9. [Genesis-mining.com - The history of bitcoin](https://www.genesis-mining.com/the-history-of-bitcoin)
10. [Bitcointalk.org - How did the First Bitcoins get Generated?](https://bitcointalk.org/index.php?topic=201782.0)
11. [Quora.com - What is the incentive for Bitcoin miners to add transactions without fees to a block](https://www.quora.com/What-is-the-incentive-for-Bitcoin-miners-to-add-transactions-without-fees-to-a-block)
12. [Businessinsider.com - bitcoin price miners making killing in transaction fees](http://www.businessinsider.com/bitcoin-price-miners-making-killing-in-transaction-fees-2017-8)
...
2. [Toddle](https://www.toddle.dev/)
3. [Appypie](https://www.appypie.com/)
4. [Builder](https://www.builder.ai/)
5. [Drag and drop page building for Angular](https://www.builder.io/)
...
2. [The Complete React Native Course: from Zero to Hero](https://www.youtube.com/watch?v=ANdSdIlgsEw)
...
4. [Rust WebAssembly with JS & TS, the practical guide](https://www.udemy.com/course/rust-webassembly-with-js-ts-the-practical-guide)
5. [The complete guide to Angular 2](https://www.udemy.com/course/the-complete-guide-to-angular-2)
6. [React-Redux](https://www.udemy.com/course/react-redux/)
...
5. [medium.com/blockchain-developer - Learn how to create your own dapp with angular part i](https://medium.com/blockchain-developer/learn-how-to-create-your-own-dapp-with-angular-part-i-688f24e0ad9e)
6. [blog.oliverjumpertz.dev - How to set up a solidity project and create your first smart contract](https://blog.oliverjumpertz.dev/how-to-set-up-a-solidity-project-and-create-your-first-smart-contract)
7. [ethereum-blockchain-developer - 01 setup Remix](https://ethereum-blockchain-developer.com/003-first-smart-contract/01-setup-remix/)
8. [medium.com/solidify - Lesson 1 your first solidity smart contract](https://medium.com/solidify/lesson-1-your-first-solidity-smart-contract-1ba7e641f9a3)
9. [How to launch Decentralized Autonomous Organization - DAO](https://decrypt.co/resources/how-to-launch-decentralized-autonomous-organization-dao)
...
32. [Getting started with Twitter Tip Bot Backend](https://github.com/bandprotocol/simple-twitter-tip-bot/tree/main/backend)
33. [learntodroid.com - How to create a simple alarm clock app in Android](https://learntodroid.com/how-to-create-a-simple-alarm-clock-app-in-android/)
